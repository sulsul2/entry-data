      ...
      <div className="flex h-screen bg-white">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex justify-start items-center gap-4 md:gap-10 px-2 md:px-10">
            <div
              className="bg-white py-3 md:py-6 px-8 md:px-16 rounded-[24px] border-[2px] border-[#E6E7EC] flex flex-col justify-center items-center gap-3 md:gap-5 text-primary-900 cursor-pointer"
